...
배열 각 요소의 JSON 구조:
{
  "word": "${isIndoMode ? '한국어 단어' : '인도네시아어 단어'}",
  "meaning": "${isIndoMode ? '인도네시아어 뜻' : '한국어 뜻'}",
  "pos": "품사 (명사, 동사, 형용사, 부사, 대명사, 수사, 전치사, 접속사, 감탄사, 한정사 중 택1 - ${explanationLang}로 표기)",
  "root": "어근 (Kata Dasar 또는 한국어 표제어)",
  "example_formal": "격식체(존댓말) 예문 (한국어)",
  "example_formal_kr": "위 격식체 예문의 인도네시아어 번역",
  "example_casual": "일상 구어체(반말) 예문 (한국어)",
  "example_casual_kr": "위 구어체 예문의 인도네시아어 번역",
  "antonym": "반대어 (${isIndoMode ? '한국어' : '인도네시아어'} 단어)",
  "synonym": "유사어 (${isIndoMode ? '한국어' : '인도네시아어'} 단어)",
